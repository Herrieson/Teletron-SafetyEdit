...
export PYTHONPATH=$PYTHONPATH:/gemini/space/yifq/Megatron-LM
export PYTHONPATH=$PYTHONPATH:/gemini/space/yifq/teleai_data_tool_source_code
...
TRAIN_SCRIPT=${1:-"examples/teleai/pretrain_s2v_recon_tae_crss.py"}
CONFIG_PATH=${2:-"config.teleai_i2v_multiresolution_v1_tokens.config"}
shift
echo "Launching: $TRAIN_SCRIPT"

TENSORBOARD_LOGS_PATH=./logs/${EXPR_NAME}
CHECKPOINT_PATH_LOAD=/gemini/space/yifq/teletron-model/Wan2.1-Fun-1.3B-InP
CHECKPOINT_PATH_SAVE=/gemini/user/shared/yifq1/workdirs/fl2v_1.3B_recon_multi_resolution_f29_sft_nocanny_I2V # use your folder
