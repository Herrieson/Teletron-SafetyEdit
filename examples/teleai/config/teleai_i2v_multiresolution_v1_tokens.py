...
buckets_size = [(832, 448), (1408, 768), (1984, 1088)] 
...
config = dict(
    dataset=dict(
        ...
        data_path_list = [os.path.join("/gemini/platform/shared/yifq1/yifq/trainable_jsons", x) for x in os.listdir("/gemini/platform/shared/yifq1/yifq/trainable_jsons")],
        filter_cfg=dict(
            dst_size=dst_size,
