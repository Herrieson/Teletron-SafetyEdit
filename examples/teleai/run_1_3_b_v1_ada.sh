...
EXPR_NAME=fl2v_1.3B_recon_multi_resolution_f29_sft_randomcanny_tae_removeattn

TRAIN_SCRIPT=${1:-"examples/teleai/pretrain_s2v_recon_tae.py"}
CONFIG_PATH=${2:-"config.teleai_i2v_multiresolution_v1_dynamic.config"}
shift
echo "Launching: $TRAIN_SCRIPT"

TENSORBOARD_LOGS_PATH=./logs/${EXPR_NAME}
CHECKPOINT_PATH_LOAD=/gemini/space/code/data/yifq1/yifq1/workdirs/fl2v_1.3B_recon_multi_resolution_f29_sft_binarycanny_dynamicstride_tae/
CHECKPOINT_PATH_SAVE=/gemini/user/shared/yifq1/workdirs/${EXPR_NAME} # use your folder
