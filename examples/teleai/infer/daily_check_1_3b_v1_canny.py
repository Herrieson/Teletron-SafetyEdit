...
CKPT_PATH = f"{folder}/iter_{int(iter_num):07d}/mp_rank_00/model_optim_rng.pt" # 10 step
CKPT_PATH = f"/gemini/user/shared/workdirs/fl2v_1.3B_recon_multi_resolution_f29_sft_binarycanny_dynamicstride_tae/distilled_f29_bfcanny.pt" # 2 step
SAVEDIR = f"/gemini/user/shared/vis_result/20260330/disable_attn_mcjcv_canny20_distilled"
...
def get_video_list():
    video_list = []
    video_list.append(["/gemini/user/shared/scripts/30zhanting.mp4", "/gemini/platform/shared/xujingyu/xujy/data/test/streamed_canny_higher_threshold.npz"])
    return video_list

# def get_video_list():
#     root_dir = "/gemini/space/code/xjy/xujy/data/avs3/AVS3_Seq/rgb_video"
    ...
    model_config=dict(
        ...
        encoder=dict(
            vae=dict(
                ...
                # path= "/gemini/platform/shared/yifq1/Wan2.1-Fun-V1.1-1.3B-InP/Wan2.1_VAE.pth"
        ...
        for t in range(NUM_OF_CLIPS):
            try:
                ...
                for k in range(len(result)):
                    ...
                    # vis_image = to_pil_image(vis_image)
                ...
                imageio.mimsave(save_path, vis_images, fps=25)
...
def run_inference_pipeline(
    ...
    inference_worker(rank=0, world_size=1, inference_configs=inference_config_list, gpu_ids=gpu_ids, canny_cnt=canny_cnt, save_dir=save_dir, enable_key_frame=enable_key_frame)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--canny_cnt', type=int, default=100,
                        help='Canny edge detection count threshold.')
