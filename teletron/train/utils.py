...
def loss_func(output_tensor):
    ...
    loss_wo_ib = output_tensor[1].mean()
    averaged_loss_wo_ib  = average_losses_across_data_parallel_group([loss_wo_ib])
    loss_wo_ib = loss_wo_ib.unsqueeze(0)
    ...
    return loss, {"loss": averaged_loss[0], "loss_wo_ib": averaged_loss_wo_ib[0], "loss_f1": averaged_loss_f1[0]}
...
def _add_checkpointing_args(parser):
    ...
    group.add_argument('--load_disc', type=str, default=None,
                       help='Directory containing a model checkpoint.')
    group.add_argument('--load_teacher', type=str, default=None,
                       help='Directory containing a model checkpoint.')
    group.add_argument('--pretrained_model_path', type=str, default=None,
                       help='Directory containing a hugging face model checkpoint.')
