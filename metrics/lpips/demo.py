...
for file in os.listdir(original_prefix):
    ...
    for i, prefix in enumerate(prefixes):
        ...
        print(f"{video_path} lpips: {mean_value}")
        if i == 0:
...
print(f"level_0_h264 lpips: {level_0_h264_mean}")
print(f"level_0_h265 lpips: {level_0_h265_mean}")
print(f"level_1_h264 lpips: {level_1_h264_mean}")
print(f"level_1_h265 lpips: {level_1_h265_mean}")
print(f"level_2_h264 lpips: {level_2_h264_mean}")
print(f"level_2_h265 lpips: {level_2_h265_mean}")
print(f"level_3_h264 lpips: {level_3_h264_mean}")
print(f"level_3_h265 lpips: {level_3_h265_mean}")
